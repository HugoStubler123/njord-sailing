...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // QSA Sailing Analytics color palette
        ...
        wind: {
          light: '#22d3ee', // Light wind cyan
          medium: '#06b6d4', // Medium wind teal
          strong: '#0891b2', // Strong wind darker teal
        },
      },
      fontFamily: {
